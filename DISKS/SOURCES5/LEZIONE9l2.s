...
In questo esempio copiamo un rettangolo tra 2 zone sovrapposte. Stavolta
l'indirizzo della destinazione e` maggiore di quello della sorgente (sullo
schermo la destinazione si trova piu` in basso).
